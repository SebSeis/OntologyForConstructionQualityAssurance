...
shape_graph_file = \
    'C:/Users/verwalter/Documents/GitHub/OntologyForConstructionQualityAssurance/07_JNL_Example/09-12-22 JNL/RuleFailure/221212_RegelPruefkostenGesamt.ttl'
...
prefix erweiterung:                <https://w3id.org/ocqa/0.3/JNL2022Masterarbeit/Erweiterung#>
			...
			SELECT #{
				?x ?Entdeckungswahrscheinlichkeit ?Wahrscheinlichkeit ?Bedeutung ?InspectionCost
			#}
			WHERE {
                ?x   rdf:type erweiterung:VirtualDefect;
				erweiterung:hasSeverityFactor ?Bedeutung;
				erweiterung:hasDetectionNumber ?Entdeckungswahrscheinlichkeit;
                erweiterung:hasProbabilityFactor ?Wahrscheinlichkeit.
				BIND (?Bedeutung * ?Entdeckungswahrscheinlichkeit * ?Wahrscheinlichkeit AS ?InspectionCost).
			}"""
